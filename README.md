...
|---|---|---|---|---|---|
| 1 | [Matrix-Vector Dot Product](https://www.deep-ml.com/problems/1) | Linear Algebra | Easy | Python · NumPy · PyTorch · CUDA · Tinygrad | [`Problem 01-Matrix_Vector Dot Product`](./matrix-vector-dot-product) |
| 2 | [Transpose of a Matrix](https://www.deep-ml.com/problems/2) | Linear Algebra | Easy | Python · NumPy · PyTorch · CUDA · Tinygrad | ['Problem 02-Transpose of a Matrix/'](./Problem 02-Transpose of a Matrix)|
